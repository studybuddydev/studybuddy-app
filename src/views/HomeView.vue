<template>
    ...
    <v-navigation-drawer permanent>
        ...
        <iframe  style="border-radius:12px" src="https://open.spotify.com/embed/playlist/37i9dQZF1DX3ChuoDUa3J5?utm_source=generator&theme=0" width="35%" height="80" frameBorder="0" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy" ></iframe>
