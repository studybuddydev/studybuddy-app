            ...
            <v-window-item value="pomodoro">
              ...
              <v-row>
                <v-col cols="12" sm="6" class="d-flex justify-space-around">
                  <v-btn-toggle color="primary" group rounded="xl" variant="flat" v-model="modeSwitch" :disabled="pomodoro.going">
                ...
                <v-col cols="12" sm="6" class="d-flex justify-space-around">
                  <v-btn-toggle color="primary" group variant="flat" v-model="selectedPreset" :disabled="freeMode || pomodoro.going">
              ...
              <v-row>
                ...
                <v-col cols="3">
                  <v-text-field v-model="endsAt" type="time" variant="underlined" dense :label= '$t("pause.timer.endTime")' :disabled="freeMode || pomodoro.going"/>
                </v-col>
              </v-row>

              <v-slider v-model="settingsStore.settings!.pomodoro!.totalLength" :min="0" :max="240" :step="5" thumb-label :disabled="freeMode || pomodoro.going"
              ...
              <v-slider v-model="settingsStore.settings!.pomodoro!.breaksLength" :min="1" :max="60" :step="1" thumb-label :disabled="freeMode || pomodoro.going"
              ...
              <v-slider v-model="settingsStore.settings!.pomodoro!.numberOfBreak" :min="0" :max="10" :step="1" thumb-label :disabled="freeMode || pomodoro.going"
