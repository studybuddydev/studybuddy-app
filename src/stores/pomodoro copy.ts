...
import { type PomodotoStatus, type Break } from '@/types';
...
export const usePomodoroStore = defineStore('pomodoro', () => {
  ...
  return {
    MINUTE_MULTIPLIER,
    breakLengthPercentage, going, itsTimeToBreak, itsFinished, getReport, itsStopped, started,
...
//   const now = Date.now();
//   const lastTick = currentPomodoro.value.lastTick;
//   const breaks = currentPomodoro.value.breaks;
//   const state = currentPomodoro.value.state;

//   let pauseEdited = false;
//   if (state == PomodoroState.STUDY) {
//     for (let i = 0; i < breaks.length; i++) {
//       //Setup
//       const b = breaks[i];
//       const lastPauseEdited = pauseEdited;
//       pauseEdited = false;

//       if (b.done) continue;

//       // Non siamo ancora in pausa
//       if (now < b.start) break;

//       // Spinge avanti pausa
//       b.end = (b.end - b.start) + now;
//       b.start = now;
//     }
//   }
